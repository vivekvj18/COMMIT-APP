...
import 'package:commit_app/Pages/Authentication/Register.dart';
                ...
                child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Text("Login Now To Connect",
                            style: TextStyle(
                                fontSize: 20, fontWeight: FontWeight.w400)),
                        Image.asset("assets/login.jpg",height: 300,width: 900),
                        TextFormField(
    ...
    if (formKey.currentState!.validate()) {
      ...
      await authService
        ...
        if (value == true) {
          ...
          await Connector_functions.saveUserNameSF(snapshot.docs[0]['fullName']);
