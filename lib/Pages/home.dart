...
import 'package:commit_app/Pages/Profile_page.dart';
import 'package:commit_app/Pages/Search_Page.dart';
import 'package:commit_app/Services/Authentication_services.dart';
import 'package:commit_app/Services/Database_services.dart';
import 'package:commit_app/Widgets/Group_tile.dart';
...
class _HomePageState extends State<HomePage> {
 ...
 void initState() {
  ...
  gettingUserData() async {
    await Connector_functions.getUserEmailFromSF().then((value) {
      setState(() {
        email = value!;
      });
    });
    await Connector_functions.getUserNameFromSF().then((val) {
      setState(() {
        userName = val!;
      });
    });
